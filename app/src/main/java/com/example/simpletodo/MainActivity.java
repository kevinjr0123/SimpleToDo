...
public class MainActivity extends AppCompatActivity {
  ...
  ItemAdaptor itemAdaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemAdaptor.OnClickListener onClickListener = new ItemAdaptor.OnClickListener() {
            @Override
        ...
        itemAdaptor = new ItemAdaptor(items, onLongClickListener, onClickListener);
        rvItem.setAdapter(itemAdaptor);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (resultCode == RESULT_OK && requestCode == EDIT_TEXT_CODE){
            ...
            itemAdaptor.notifyItemChanged(position);
    ...
    //This function will load items by reading
